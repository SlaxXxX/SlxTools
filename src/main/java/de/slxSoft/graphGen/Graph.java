...
public class Graph {
    ...
    /**
     * DEFAULT is 100<br><br>
     *
     * @param size Size of the Array<br><br>
     *
    ...
    /**
     * DEFAULT is "50 + 3.5 * x" --> with default size a function that ranges from 50 - 400<br><br>
     *
     * @param function A String that contains the Function that the Graph will determine values after<br><br>
     *
     *
     * "x" is a predefined variable, other variables are not allowed<br>
     ...
     * DEFAULT is 0<br><br>
     *
     * @param speed ChangeSpeed defines the chance for the curve to change it's value<br><br>
     *
     ...
     * DEFAULT is 20<br><br>
     *
     * To further reduce noise, the curve will be on a "cooldown" after a big value change<br><br>
     *
     ...
     *
     * If Generator.generate() wasn't executed yet, this will be empty<br>
     ...
     * Use this Method to specifically generate the values for this Graph only
     */
    public int[] generate(long seed) {
        ...
        for (int i = 0; i <= size; i++) {
            ...
            values[i] = distort(values[i - Math.min(i, 1)], values[i], random.nextDouble());

        }
        return values;
    }

    private int distort(int lastval, int thisval, double random) {
